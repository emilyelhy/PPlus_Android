...
export default function MicrophoneSettingPage({ route }) {
    ...
    return (
        <SafeAreaView style={{ flex: 1, justifyContent: "space-around", backgroundColor: "#DAE2E1" }}>
            <Text style={{ left: "3%", top: "2%", position: "absolute", fontSize: 25, fontWeight: "600", color: "#7B8D93" }}>Microphone Setting</Text>
            <View>
                ...
                <View style={{ backgroundColor: "#E8E8E8", paddingTop: '1%', marginHorizontal: '8%', marginTop: '3%' }}>
                    <View style={{ flexDirection: "row", justifyContent: "space-between", marginTop: "3%" }}>
                        <Text style={{ color: "#7B8D93", fontSize: 18, fontWeight: "500", marginHorizontal: "3%", alignSelf: "center" }}>Sensitivity</Text>
                        <Text style={{ color: "#7B8D93", fontSize: 15, fontWeight: "500", marginHorizontal: "3%", alignSelf: "center" }}>{sensitivity}</Text>
                    </View>
                    <Slider
                ...
                <View style={{ flexDirection: "row", backgroundColor: "#E8E8E8", padding: '1%', marginHorizontal: '8%', marginTop: '3%', justifyContent: "space-between" }}>
                    <Text style={{ color: "#7B8D93", fontSize: 18, fontWeight: "500", marginHorizontal: "3%", marginVertical: "3%" }}>Noise cancellation</Text>
                    <CheckBox
